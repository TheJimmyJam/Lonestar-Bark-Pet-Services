...
serve(async (req) => {
  ...
  try {
    const { walkerName, walkerEmail, clientName, pet, service, date, day, time, duration, price } = await req.json();
    ...
    const subject = `${svc.emoji} New Booking — ${clientName}'s ${pet} on ${day}, ${date}`;
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f4f4;padding:32px 0;">
    <tr><td align="center">
      <table width="580" cellpadding="0" cellspacing="0" style="max-width:580px;width:100%;background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        <!-- Banner -->
        <tr>
          <td style="background:#C4541A;padding:14px 32px;text-align:center;">
            <p style="margin:0;font-size:16px;font-weight:700;color:#ffffff;">
              ${svc.emoji} You've got a new booking!
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:28px 32px 8px;">
            ...
            <p style="margin:12px 0 0;font-size:15px;color:#444444;line-height:1.6;">
              A new booking has been scheduled and assigned to you. Here are the details:
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:16px 32px;">
            <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8f8f8;border-radius:8px;border:1px solid #e8e8e8;overflow:hidden;">
              <tr>
                <td style="padding:20px 24px;">
                  <table width="100%" cellpadding="0" cellspacing="6">
                    ...
                    <tr>
                      <td style="font-size:13px;color:#888;padding:5px 0;">Price</td>
                      <td style="font-size:14px;color:#C4541A;font-weight:700;padding:5px 0;">${priceStr}</td>
                    </tr>
                  </table>
                </td>
              </tr>
        ...
        <tr>
          <td style="padding:8px 32px 32px;">
            <p style="margin:0;font-size:13px;color:#888888;line-height:1.6;">
              Please log into the Lonestar Bark Co. portal to review your schedule. If you have any questions, reach out to the team.
            </p>
          </td>
        </tr>
    ...
    const res = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({ from: FROM, to: walkerEmail, subject, html }),
    });
